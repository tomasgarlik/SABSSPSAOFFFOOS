...
//         if (selected) {
//             fg = {0, 0, 0, 255};
//             bg = {20, 120, 255, 100};  // modré pozadí
//         } else {
//             fg = {0, 0, 0, 255};
...
SDL_Texture* createTextTexture(SDL_Renderer* renderer, const std::string& text, int start_of_selected = -1, int end_of_selected = -1, int r=0,int g=0,int b=0)
{
